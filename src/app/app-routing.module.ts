...
const routes: Routes = [
  ...
  {path: 'form-controls', component: TemplateFormControlsComponent, title: "Sign In"},
...
@NgModule({
  declarations: [],  //*routing module only contains "routes". thats why you see declarations array is empty
  imports: [
    CommonModule, // no need because app.module imports it already
